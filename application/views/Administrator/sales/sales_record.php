                ...
                <table class="record-table"
                    ...
                    <tbody>
                        <template v-for="sale in sales">
                            <tr tr :style="{background: sale.Status == 'p' ? 'rgb(255 251 220)' : ''}">
                                ...
                                <td style="text-align:right;">{{ sale.SaleMaster_loadingCost }}</td>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <a href="" title="Chalan" v-bind:href="`/chalan/${sale.SaleMaster_SlNo}`"
                                        target="_blank"><i class="fa fa-file-o"></i></a>
                                    <a v-if="sale.isEditEnable == 'yes'" href="javascript:" title="Edit Sale"
                                        @click="checkReturnAndEdit(sale)"><i class="fa fa-edit"></i></a>
                                    <?php if ($this->session->userdata('accountType') != 'u') { ?>
                                    <a v-if="sale.Status == 'p'" href="" title="Approve"
                                        @click.prevent="approveItem(sale.SaleMaster_SlNo)"><i style="font-size:18px"
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                {{ sales.reduce((prev, curr)=>{return prev + parseFloat(curr.SaleMaster_loadingCost)}, 0) }}
                            </td>
                            <td style="text-align:right;">
