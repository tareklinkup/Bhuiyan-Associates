                        ...
                        <div class="col-sm-5">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group">
                                    ...
                                    <label id="convert_quantity_name" class="col-xs-2 no-padding text-right"> </label>
                                    <div class="col-xs-3 no-padding-left">
                                        <input type="number" step="0.01" min="0" id="convert_quantity" placeholder=""
                                            class="form-control" ref="convert_quantity"
                                            v-model="selectedProduct.convert_quantity" v-on:input="productTotal"
    ...
    methods: {
        ...
        productTotal() {
            ...
            this.selectedProduct.total = ((parseFloat(this.selectedProduct.quantity) + (parseFloat(this
                .selectedProduct.convert_quantity) * parseFloat(this.selectedProduct
                .convert_qty))) * parseFloat(this.selectedProduct.Product_SellingPrice - this
        ...
        addToCart() {
            let product = {
                ...
                quantity: parseFloat(this.selectedProduct.convert_quantity * parseFloat(this.selectedProduct
                    .convert_qty)) + parseFloat(this.selectedProduct.quantity),
