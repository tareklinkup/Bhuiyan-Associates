                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group clearfix">
                                    <label class="control-label col-md-4 no-padding">Transfer date</label>
                                    <div class="col-md-8">
                                        <input type="date" class="form-control" v-model="transfer.transfer_date">
                                    </div>
                                </div>
                                <!-- <div class="form-group clearfix">
                                    <label class="control-label col-md-4 no-padding">Transfer by Emp.</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group clearfix">
                                    <label class="control-label col-md-4 no-padding">Transfer From</label>
                                    <div class="col-md-8">
                                        <input type="text" value="<?= $this->session->userdata('Brunch_name') ?>" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <label class="control-label col-md-4 no-padding">Transfer to</label>
                                    <div class="col-md-8">
            ...
            async getBranches() {
                await axios.get('/get_branches').then(res => {
                    ...
                    response.forEach(ele => {
                        if (ele.brunch_id == currentBranchId && ele.MainBranch_Id != null) {
                            isBranch = false;
                            mainBranch = ele.MainBranch_Id;
                        }
                    });

                    if (isBranch) {
                        this.branches = res.data.filter((obj) => {
                            return ((obj.MainBranch_Id == currentBranchId || (obj.MainBranch_Id == null && obj.brunch_id != currentBranchId)) && obj.active_status == 'Active')
                        });
                    } else {
                        this.branches = res.data.filter((obj) => {
                            return (obj.brunch_id == mainBranch && obj.active_status == 'Active')
                        });
