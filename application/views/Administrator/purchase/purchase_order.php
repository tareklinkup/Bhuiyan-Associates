                        ...
                        <div class="col-sm-6">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group">
                                    ...
                                    <label id="convert_quantity_name"
                                        class="col-xs-2 control-label no-padding-right text-right"> </label>
                                    <div class="col-xs-3">
                                        <input type="number" step="1" min="0" id="convert_quantity" class="form-control"
                                            placeholder="" v-model="selectedProduct.convert_quantity"
...
new Vue({
    ...
    methods: {
        ...
        productTotal() {
            ...
            if (this.selectedProduct.Product_SlNo != '') {
                let totalQty = parseFloat(this.selectedProduct.convert_quantity * parseFloat(this
                    .selectedProduct.convert_qty)) + parseFloat(this.selectedProduct.quantity);
